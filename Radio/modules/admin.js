...
export class AdminPanel {
    ...
    /** Reads current broadcast state and updates the on-air badge + info panel. */
    ...
    /** Reads the broadcast form and starts a new broadcast. */
    async goLive() {
    ...
    /**
     * Advances the broadcast to the next track by rewinding playlistStartedAt
     * to the exact ms offset of the next song.
     */
    async skipTrack() {
        const state = await this.db.kv.get('radio_state');
    ...
    async approveSubmission(id) {
        ...
        // Strip submission-only fields before adding to library
