  ...
  <div class="comments-container">
    ...
    <form class="comment-form" id="comment-form">
      ...
      <div class="comment-form-footer">
        <span class="comment-status" id="comment-status">Angemeldet als Gast — Es kann etwas dauern, bis neue Kommentare reflektiert werden</span>
